    ...
    *,
    ...
    try:
        ...
        if _table_exists(connection, "session_compactions"):
            from .support.context_compaction import (
                compaction_scope_id,
...
def _migrate_gateway(
    ...
    *,
    ...
    connection.row_factory = sqlite3.Row
    try:
        from .support.mobile_gateway import _encode_stored_event, _new_ulid
...
def unify_akashic_identity(_connection: object) -> None:
    ...
    try:
        if has_old_sessions:
            from .support.akasha_embedding_backfill import (
        ...
        if session_map:
            from .support.akasha_sidecar import rebuild_akasha_sidecars
