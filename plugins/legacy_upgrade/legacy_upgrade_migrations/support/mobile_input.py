...
# Keep the schema lineage in the historical bundle.  The runtime storage owner
# may evolve after this migration ships, while this DDL must remain byte-stable.
