...
from agent.plugin_contracts.message import decode_body, encode_body, json_value

# Frozen schema facts required to read old SessionDB snapshots.  The active
# storage owner may evolve separately; this bundle keeps the migration
# acceptance boundary stable for historical databases.
ARTIFACT_SCHEMA = {
