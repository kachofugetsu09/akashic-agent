"""纠正 20260918_01：Akasha 选择属于 workspace 配置，凭据必须放在 memory root。
...
__depends__ = {"20260918_01_register_graph_replay"}
...
def request_akasha_replay(_connection: object) -> None:
    ...
    if _memory_engine(context.workspace, context.config_path) != "akasha":
        return
