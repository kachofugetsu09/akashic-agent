"""一次性登记 Akasha 学习图重放：迁移只取恢复点并写下凭据。
...
_BUNDLE_ID = "akasha"
_REQUEST_NAME = "rebuild-request.json"
_SCHEMA_VERSION = 1
_CURRENT_CONSUMPTION_VERSION = 2


def _memory_engine(config_path: Path) -> str:
    """读取 memory 配置；未启用 Akasha 的安装不做任何变换。"""
