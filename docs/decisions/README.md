...
| [0054](0054-agent-spine-is-ordinary-plugins.md) | accepted | Agent 内骨架由七个普通插件组成 | STA-001～STA-003、CAP-001～CAP-002、RUN-001～RUN-012、OUT-001～OUT-005、PLG-001～PLG-018、TST-001～TST-006 |
