...
- 取代者：Skill 部分由 [插件 Skills 组合能力合同](plugin-skills-service-task-contract.md)取代；Dashboard 部分由 [插件 UI Slots 组合能力合同](plugin-ui-slots-service-task-contract.md)取代。过渡 `PLUGIN_ASSETS` 公开面已经删除。
