...
| 执行失败、自愈、跳过与重试 | [0063](decisions/0063-execution-failures-have-terminal-results.md) → [持久化状态地图](design/persistence-state-map.md) → [中断、工具结算与宿主故障模型](design/interrupt-and-fault-model.md) | `plugins/tools/`、`plugins/delivery/`、`plugins/wake/`、`plugins/reply/`、`plugins/conversation/`、`infra/mobile_realtime/`、`migrations/yoyo/20260909_02_execution_failures.py` |
