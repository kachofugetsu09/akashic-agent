...
| 执行失败、自愈、跳过与重试 | [0063](decisions/0063-execution-failures-have-terminal-results.md) → [持久化状态地图](design/persistence-state-map.md) | `plugins/tools/`、`plugins/delivery/`、`plugins/wake/`、`infra/mobile_realtime/` |
