...
_MIGRATION_PATH = _PROJECT_ROOT / "plugins/legacy_upgrade/legacy_upgrade_migrations/20260826_01_migrate_turn_effects.py"


def _load_migration():
    """Load the migration callback without wrapping it in Yoyo."""
    return load_migration_namespace("20260826_01_migrate_turn_effects")
